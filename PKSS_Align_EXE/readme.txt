...
1. Use PKSS-Align with default parameter input
    ...
    Parameter 1: input source file path (Instance：Data\source.ply)
    Parameter 2: input template file path (Instance：Data\template.ply)

    The output point cloud is stored in the path of source file (Data\source_align.ply)
